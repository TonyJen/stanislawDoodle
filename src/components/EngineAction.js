...
class EngineAction extends React.Component {
  ...
  tick = (params) => {
    ...
    if (params && params.lastTick) {
      ...
      var pos = this.props.easing(
        transitionTime / (this.state.endTime - this.state.startTime),
      );
    }
  ...
  render() {
    return (
      <div key={this.state.id}>{/* Render content based on state here */}</div>
    );
  }
...
EngineAction.propTypes = {
  ...
  innerId: PropTypes.number.isRequired,
  properties: PropTypes.object.isRequired,
  onFinish: PropTypes.func.isRequired,
  align: PropTypes.string.isRequired,
  playCount: PropTypes.number.isRequired,
  maxPlayCount: PropTypes.number.isRequired,
  easing: PropTypes.func.isRequired,
  alternate: PropTypes.bool.isRequired,
  clearOnFinish: PropTypes.bool.isRequired,
};
