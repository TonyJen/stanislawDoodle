...
const BattleOfTheSexes = () => {
    ...
    return (
        <Container maxWidth="md">
            ...
            <Grid item xs={12}>
                <Box mt={2}>
                    <Button variant="contained" color="primary" onClick={revealResults}>
                        Reveal Results
                    </Button>
                </Box>
            </Grid>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            <TableRow>
                                ...
                                <TableCell
                                    style={{
                                        backgroundColor: highlight === "(2,1)" ? "yellow" : "",
                                    }}
                                >
                                    (2,1)
                                </TableCell>
                                <TableCell
                                    style={{
                                        backgroundColor: highlight === "(0,0)" ? "yellow" : "",
                                    }}
                                >
                                    (0,0)
                                </TableCell>
                            ...
                            <TableRow>
                                ...
                                <TableCell
                                    style={{
                                        backgroundColor: highlight === "(1,2)" ? "yellow" : "",
                                    }}
                                >
                                    (1,2)
                                </TableCell>
